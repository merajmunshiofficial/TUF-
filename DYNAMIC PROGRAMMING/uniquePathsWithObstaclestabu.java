class uniquePathsWithObstaclestabu {
    ...
    public static void main(String[] args) {
        ...
        // Create an instance of uniquePathsWithObstaclestabu class
        uniquePathsWithObstaclestabu sol = new uniquePathsWithObstaclestabu();
